...
namespace SafeTrace.Infrastructure.Services
{
    public class AccountService : IAccountService
    {
        ...
        private readonly IEmailServiceSendGrid _emailService;
        ...
        public AccountService(
            ...
            IEmailServiceSendGrid emailService,
        ...
        {
            var storedToken = await _unitOfWork.RefreshTokenRepository.GetOneAsync(t => t.Token == token);
        ...
        {
            var existingOtps = await _unitOfWork.UserOtpRepository.GetAllAsync(o => o.UserId == userId && o.Type == type && !o.IsUsed);
            foreach (var existingOtp in existingOtps)
            {
                existingOtp.IsUsed = true;
                await _unitOfWork.UserOtpRepository.UpdateAsync(existingOtp);
            }
            ...
            await _unitOfWork.UserOtpRepository.CreateAsync(userOtp);
            await _unitOfWork.SaveAsync();
            return randomCode;
        }
        ...
        {
            var userOtp = await _unitOfWork.UserOtpRepository.GetOneAsync(o => o.UserId == userId && o.Code == code && o.Type == type && !o.IsUsed && o.ExpiryTime > DateTime.UtcNow);
            if (userOtp == null) return false;

            userOtp.IsUsed = true;
            await _unitOfWork.UserOtpRepository.UpdateAsync(userOtp);
            await _unitOfWork.SaveAsync();
            return true;
        }
