    ...
    public class LongTermCaseMappingProfile : Profile
    {
        public LongTermCaseMappingProfile()
        {
            ...
            CreateMap<CreateLongTermCaseDto, LongTermMissingCase>()
                ...
                .ForMember(d => d.DeletedByUserId, opt => opt.Ignore())
                .ForMember(d => d.PreviousStatus, opt => opt.Ignore())
                ...
                .ForMember(d => d.DuplicateGroups, opt => opt.Ignore())
                .ForMember(d => d.AgeCategoryId, opt => opt.Ignore())
                .ForMember(d => d.AgeCategory, opt => opt.Ignore())
                .ForMember(d => d.PoliceReportImage, opt => opt.Ignore());

            CreateMap<UpdateLongTermCaseDto, LongTermMissingCase>()
                .ForMember(d => d.Id, opt => opt.Ignore())
                .ForMember(d => d.Status, opt => opt.Ignore())
                .ForMember(d => d.CaseCode, opt => opt.Ignore())
                .ForMember(d => d.CreatedAt, opt => opt.Ignore())
                ...
                .ForMember(d => d.AgeCategoryId, opt => opt.Ignore())
                .ForMember(d => d.AgeCategory, opt => opt.Ignore())
                // PoliceReportImage is handled manually in the service (only replaced if a new file is provided).
                .ForMember(d => d.PoliceReportImage, opt => opt.Ignore());
        }
    }
}