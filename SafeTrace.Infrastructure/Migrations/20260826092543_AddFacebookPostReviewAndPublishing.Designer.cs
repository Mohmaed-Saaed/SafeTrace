...
namespace SafeTrace.Infrastructure.Migrations
{
    ...
    [Migration("20260826092543_AddFacebookPostReviewAndPublishing")]
    partial class AddFacebookPostReviewAndPublishing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SafeTrace.Domain.Entities.FacebookImportedPost", b =>
                {
                    ...
                    b.Property<long?>("DuplicateCaseId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FacebookImportedPosts", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FacebookImportedPosts_CaseReferences", "[CaseId] IS NULL OR [DuplicateCaseId] IS NULL");
            ...
            modelBuilder.Entity("SafeTrace.Domain.Entities.FacebookImportedPost", b =>
                {
                    ...
                    b.HasOne("SafeTrace.Domain.Entities.Case", "DuplicateCase")
                        .WithMany()
                        .HasForeignKey("DuplicateCaseId")
                        .OnDelete(DeleteBehavior.Restrict);
